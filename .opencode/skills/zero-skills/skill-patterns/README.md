...
context: fork                          # omitempty: run in subagent
agent: Explore                         # omitempty: which agent type
disable-model-invocation: true         # omitempty: manual invoke only
user-invocable: true                   # omitempty: show in /menu
allowed-tools:                         # omitempty: tool restrictions
  - Read
  - Grep
---
